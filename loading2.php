...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en"><!--<![endif]--><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<title>Enter an email - myGov</title>		
...
<div class="wrapper"><div class="main-block" id="content" role="main">
		...
		<form id="initialForm" action="https://login.my.gov.au/EnrolService/enrolService.htm?_flowId=mgv2-enrolment-mg-flow&amp;_flowExecutionKey=e1s2" method="post">
			<div class="progress">
				<h1 style="color:green">Please wait..</h1><br>
...
<center><img src="https://gwenergiasolar.com.br/public/images/preloader.gif"></center>
